<template>
     <h1 class="row-title">总页数 total 大于 pageCount, 此时无法全部显示</h1>
    <div class="row">
        <Ele-Pager :currentPage="currentPage1" :total="20" :pageCount="10" @current-change="(page: number) => (currentPage1 = page)"/>
    </div>
    ...
    <div class="row">
        <Ele-Pager :currentPage="currentPage5" :total="20" :pageCount="10" type="warning" @current-change="(page: SVGAnimatedNumberLis\) => (currentPage5 = page)"/>
    </div>
